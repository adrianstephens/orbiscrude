...
enum CV_HREG_e {
	// Register subset shared by all processor types, must not overlap with any of the ranges below, hence the high values
	CV_ALLREG_ERR		= 30000,
	CV_ALLREG_TEB		= 30001,
	...
	//Lower/upper 8 bytes of XMM registers.  Unlike CV_AMD64_XMM<regnum><H/L>, these values reprsesent the bit patterns of the registers as 64-bit integers, not the representation of these registers as a double.
	CV_AMD64_XMM0IL		= 400,
	CV_AMD64_XMM1IL		= 401,
	CV_AMD64_XMM2IL		= 402,
	CV_AMD64_XMM3IL		= 403,
