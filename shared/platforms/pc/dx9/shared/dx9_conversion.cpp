...
//			{ISO::getdef<norm3_10_10_10>(),	D3DDECLTYPE_DEC3N		},
		...
		static struct { crc32 id; int usage; int index; } known_uses[] = {
			...
			{"centre",			D3DDECLUSAGE_POSITION, 		1},
			{"normal",			D3DDECLUSAGE_NORMAL,		0},
			{"smooth_normal",	D3DDECLUSAGE_NORMAL,		1},
			{"colour",			D3DDECLUSAGE_COLOR,			0},
			{"texcoord0",		D3DDECLUSAGE_TEXCOORD,		0},
			{"texcoord1",		D3DDECLUSAGE_TEXCOORD,		1},
			{"texcoord2",		D3DDECLUSAGE_TEXCOORD,		2},
			{"texcoord3",		D3DDECLUSAGE_TEXCOORD,		3},
			{"texcoord4",		D3DDECLUSAGE_TEXCOORD,		4},
			{"texcoord5",		D3DDECLUSAGE_TEXCOORD,		5},
			{"texcoord6",		D3DDECLUSAGE_TEXCOORD,		6},
			{"texcoord7",		D3DDECLUSAGE_TEXCOORD,		7},
			{"tangent0",		D3DDECLUSAGE_TANGENT,		0},
			{"tangent1",		D3DDECLUSAGE_TANGENT,		1},
			{"tangent2",		D3DDECLUSAGE_TANGENT,		2},
			{"tangent3",		D3DDECLUSAGE_TANGENT,		3},
			{"tangent4",		D3DDECLUSAGE_TANGENT,		4},
			{"tangent5",		D3DDECLUSAGE_TANGENT,		5},
			{"tangent6",		D3DDECLUSAGE_TANGENT,		6},
			{"tangent7",		D3DDECLUSAGE_TANGENT,		7},
			{"weights",			D3DDECLUSAGE_BLENDWEIGHT,	0},
			{"bones",			D3DDECLUSAGE_BLENDINDICES,	0},
		};
