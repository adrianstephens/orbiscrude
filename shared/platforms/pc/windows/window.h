...
enum MSG_ID {
	kWM_NULL = 0x0000,					kWM_CREATE = 0x0001,			kWM_DESTROY = 0x0002,				kWM_MOVE = 0x0003,					kWM_SIZE = 0x0005,
	kWM_ACTIVATE = 0x0006,				kWM_SETFOCUS = 0x0007,			kWM_KILLFOCUS = 0x0008,				kWM_SETVISIBLE = 0x0009,			kWM_ENABLE = 0x000A,
	kWM_SETREDRAW = 0x000B,				kWM_SETTEXT = 0x000C,			kWM_GETTEXT = 0x000D,				kWM_GETTEXTLENGTH = 0x000E,			kWM_PAINT = 0x000F,					kWM_CLOSE = 0x0010,				kWM_QUERYENDSESSION = 0x0011,
	kWM_QUIT = 0x0012,					kWM_QUERYOPEN = 0x0013,			kWM_ERASEBKGND = 0x0014,			kWM_SYSCOLORCHANGE = 0x0015,		kWM_ENDSESSION = 0x0016,			kWM_SYSTEMERROR = 0x0017,		kWM_SHOWWINDOW = 0x0018,		kWM_CTLCOLOR = 0x0019,
	kWM_SETTINGCHANGE = 0x001A,			kWM_DEVMODECHANGE = 0x001B,		kWM_ACTIVATEAPP = 0x001C,			kWM_FONTCHANGE = 0x001D,			kWM_TIMECHANGE = 0x001E,			kWM_CANCELMODE = 0x001F,		kWM_SETCURSOR = 0x0020,			kWM_MOUSEACTIVATE = 0x0021,
	kWM_CHILDACTIVATE = 0x0022,			kWM_QUEUESYNC = 0x0023,			kWM_GETMINMAXINFO = 0x0024,			kWM_LOGOFF = 0x0025,				kWM_PAINTICON = 0x0026,				kWM_ICONERASEBKGND = 0x0027,	kWM_NEXTDLGCTL = 0x0028,		kWM_ALTTABACTIVE = 0x0029,
	kWM_SPOOLERSTATUS = 0x002A,			kWM_DRAWITEM = 0x002B,			kWM_MEASUREITEM = 0x002C,			kWM_DELETEITEM = 0x002D,			kWM_VKEYTOITEM = 0x002E,			kWM_CHARTOITEM = 0x002F,		kWM_SETFONT = 0x0030,			kWM_GETFONT = 0x0031,
	kWM_SETHOTKEY = 0x0032,				kWM_GETHOTKEY = 0x0033,			kWM_FILESYSCHANGE = 0x0034,			kWM_ISACTIVEICON = 0x0035,			kWM_UNUSED0036 = 0x0036,			kWM_QUERYDRAGICON = 0x0037,		kWM_WINHELP = 0x0038,			kWM_COMPAREITEM = 0x0039,
	kWM_FULLSCREEN = 0x003A,			kWM_CLIENTSHUTDOWN = 0x003B,	kWM_DDEMLEVENT = 0x003C,			kWM_TESTING = 0x0040,				kWM_COMPACTING = 0x0041,			kWM_OTHERWINDOWCREATED = 0x0042,kWM_OTHERWINDOWDESTROYED = 0x0043,
	...
	kWM_NCXBUTTONDBLCLK = 0x00AD,

	kEM_GETSEL = 0x00B0,				kEM_SETSEL = 0x00B1,			kEM_GETRECT = 0x00B2,				kEM_SETRECT = 0x00B3,				kEM_SETRECTNP = 0x00B4,				kEM_SCROLL = 0x00B5,			kEM_LINESCROLL = 0x00B6,
	kEM_SCROLLCARET = 0x00B7,			kEM_GETMODIFY = 0x00B8,			kEM_SETMODIFY = 0x00B9,				kEM_GETLINECOUNT = 0x00BA,			kEM_LINEINDEX = 0x00BB,				kEM_SETHANDLE = 0x00BC,			kEM_GETHANDLE = 0x00BD,			kEM_GETTHUMB = 0x00BE,
	kEM_LINELENGTH = 0x00C1,			kEM_REPLACESEL = 0x00C2,		kEM_GETLINE = 0x00C4,				kEM_SETLIMITTEXT = 0x00C5,			kEM_CANUNDO = 0x00C6,				kEM_UNDO = 0x00C7,				kEM_FMTLINES = 0x00C8,			kEM_LINEFROMCHAR = 0x00C9,
	kEM_SETTABSTOPS = 0x00CB,			kEM_SETPASSWORDCHAR = 0x00CC,	kEM_EMPTYUNDOBUFFER = 0x00CD,		kEM_GETFIRSTVISIBLELINE = 0x00CE,	kEM_SETREADONLY = 0x00CF,			kEM_SETWORDBREAKPROC = 0x00D0,	kEM_GETWORDBREAKPROC = 0x00D1,	kEM_GETPASSWORDCHAR = 0x00D2,
	kEM_SETMARGINS = 0x00D3,			kEM_GETMARGINS = 0x00D4,		kEM_GETLIMITTEXT = 0x00D5,			kEM_POSFROMCHAR = 0x00D6,			kEM_CHARFROMPOS = 0x00D7,			kEM_SETIMESTATUS = 0x00D8,		kEM_GETIMESTATUS = 0x00D9,
	...
	kWM_INPUT = 0x00FF,
	kWM_KEYDOWN = 0x0100,				kWM_KEYUP = 0x0101,				kWM_CHAR = 0x0102,					kWM_DEADCHAR = 0x0103,				kWM_SYSKEYDOWN = 0x0104,			kWM_SYSKEYUP = 0x0105,			kWM_SYSCHAR = 0x0106,			kWM_SYSDEADCHAR = 0x0107,
	kWM_YOMICHAR = 0x0108,				kWM_CONVERTREQUEST = 0x010A,	kWM_CONVERTRESULT = 0x010B,			kWM_INTERIM = 0x010C,				kWM_IME_STARTCOMPOSITION = 0x010D,	kWM_IME_ENDCOMPOSITION = 0x010E,kWM_IME_COMPOSITION = 0x010F,	kWM_INITDIALOG = 0x0110,
	kWM_COMMAND = 0x0111,				kWM_SYSCOMMAND = 0x0112,		kWM_TIMER = 0x0113,					kWM_HSCROLL = 0x0114,				kWM_VSCROLL = 0x0115,				kWM_INITMENU = 0x0116,			kWM_INITMENUPOPUP = 0x0117,		kWM_SYSTIMER = 0x0118,
	kWM_MENUSELECT = 0x011F,			kWM_MENUCHAR = 0x0120,			kWM_ENTERIDLE = 0x0121,				kWM_MENURBUTTONUP = 0x0122,			kWM_MENUDRAG = 0x0123,				kWM_MENUGETOBJECT = 0x0124,		kWM_UNINITMENUPOPUP = 0x0125,	kWM_MENUCOMMAND = 0x0126,
	kWM_CHANGEUISTATE = 0x0127,			kWM_UPDATEUISTATE = 0x0128,		kWM_QUERYUISTATE = 0x0129,			kWM_CTLCOLORMSGBOX = 0x0132,		kWM_CTLCOLOREDIT = 0x0133,			kWM_CTLCOLORLISTBOX = 0x0134,	kWM_CTLCOLORBTN = 0x0135,		kWM_CTLCOLORDLG = 0x0136,
	kWM_CTLCOLORSCROLLBAR = 0x0137,		kWM_CTLCOLORSTATIC = 0x0138,

	kCB_GETEDITSEL = 0x0140,			kCB_LIMITTEXT = 0x0141,			kCB_SETEDITSEL = 0x0142,			kCB_ADDSTRING = 0x0143,				kCB_DELETESTRING = 0x0144,			kCB_DIR = 0x0145,
	kCB_GETCOUNT = 0x0146,				kCB_GETCURSEL = 0x0147,			kCB_GETLBTEXT = 0x0148,				kCB_GETLBTEXTLEN = 0x0149,			kCB_INSERTSTRING = 0x014A,			kCB_RESETCONTENT = 0x014B,		kCB_FINDSTRING = 0x014C,		kCB_SELECTSTRING = 0x014D,
	kCB_SETCURSEL = 0x014E,				kCB_SHOWDROPDOWN = 0x014F,		kCB_GETITEMDATA = 0x0150,			kCB_SETITEMDATA = 0x0151,			kCB_GETDROPPEDCONTROLRECT = 0x0152,	kCB_SETITEMHEIGHT = 0x0153,		kCB_GETITEMHEIGHT = 0x0154,		kCB_SETEXTENDEDUI = 0x0155,
	kCB_GETEXTENDEDUI = 0x0156,			kCB_GETDROPPEDSTATE = 0x0157,	kCB_FINDSTRINGEXACT = 0x0158,		kCB_SETLOCALE = 0x0159,				kCB_GETLOCALE = 0x015A,				kCB_GETTOPINDEX = 0x015B,		kCB_SETTOPINDEX = 0x015C,		kCB_GETHORIZONTALEXTENT = 0x015D,
	kCB_SETHORIZONTALEXTENT = 0x015E,	kCB_GETDROPPEDWIDTH = 0x015F,	kCB_SETDROPPEDWIDTH = 0x0160,		kCB_INITSTORAGE = 0x0161,
	...
	kLB_SETITEMHEIGHT = 0x01A0,			kLB_GETITEMHEIGHT = 0x01A1,		kLB_FINDSTRINGEXACT = 0x01A2,		kLBCB_CARETON = 0x01A3,				kLBCB_CARETOFF = 0x01A4,			kLB_SETLOCALE = 0x01A5,			kLB_GETLOCALE = 0x01A6,			kLB_SETCOUNT = 0x01A7,
	kLB_INITSTORAGE = 0x01A8,			kLB_ITEMFROMPOINT = 0x01A9,		kLB_INSERTSTRINGUPPER = 0x01AA,		kLB_INSERTSTRINGLOWER = 0x01AB,		kLB_ADDSTRINGUPPER = 0x01AC,		kLB_ADDSTRINGLOWER = 0x01AD,

	kMN_SETHMENU = 0x01E0,				kMN_GETHMENU = 0x01E1,
	kMN_SIZEWINDOW = 0x01E2,			kMN_OPENHIERARCHY = 0x01E3,		kMN_CLOSEHIERARCHY = 0x01E4,		kMN_SELECTITEM = 0x01E5,			kMN_CANCELMENUS = 0x01E6,			kMN_SELECTFIRSTVALIDITEM = 0x01E7,kMN_GETPPOPUPMENU = 0x01EA,	kMN_FINDMENUWINDOWFROMPOINT = 0x01EB,
	kMN_SHOWPOPUPWINDOW = 0x01EC,		kMN_BUTTONDOWN = 0x01ED,		kMN_MOUSEMOVE = 0x01EE,				kMN_BUTTONUP = 0x01EF,				kMN_SETTIMERTOOPENHIERARCHY = 0x01F0,kMN_DBLCLK = 0x01F1,

	kWM_MOUSEMOVE = 0x0200,				kWM_LBUTTONDOWN = 0x0201,
	kWM_LBUTTONUP = 0x0202,				kWM_LBUTTONDBLCLK = 0x0203,		kWM_RBUTTONDOWN = 0x0204,			kWM_RBUTTONUP = 0x0205,				kWM_RBUTTONDBLCLK = 0x0206,			kWM_MBUTTONDOWN = 0x0207,		kWM_MBUTTONUP = 0x0208,			kWM_MBUTTONDBLCLK = 0x0209,
	kWM_MOUSEWHEEL = 0x020A,			kWM_XBUTTONDOWN = 0x020B,		kWM_XBUTTONUP = 0x020C,				kWM_XBUTTONDBLCLK = 0x020D,			kWM_PARENTNOTIFY = 0x0210,			kWM_ENTERMENULOOP = 0x0211,		kWM_EXITMENULOOP = 0x0212,		kWM_NEXTMENU = 0x0213,
	kWM_SIZING = 0x0214,				kWM_CAPTURECHANGED = 0x0215,	kWM_MOVING = 0x0216,				kWM_POWERBROADCAST = 0x0218,		kWM_DEVICECHANGE = 0x0219,			kWM_MDICREATE = 0x0220,			kWM_MDIDESTROY = 0x0221,		kWM_MDIACTIVATE = 0x0222,
	kWM_MDIRESTORE = 0x0223,			kWM_MDINEXT = 0x0224,			kWM_MDIMAXIMIZE = 0x0225,			kWM_MDITILE = 0x0226,				kWM_MDICASCADE = 0x0227,			kWM_MDIICONARRANGE = 0x0228,	kWM_MDIGETACTIVE = 0x0229,		kWM_DROPOBJECT = 0x022A,
	kWM_QUERYDROPOBJECT = 0x022B,		kWM_BEGINDRAG = 0x022C,			kWM_DRAGLOOP = 0x022D,				kWM_DRAGSELECT = 0x022E,			kWM_DRAGMOVE = 0x022F,				kWM_MDISETMENU = 0x0230,		kWM_ENTERSIZEMOVE = 0x0231,		kWM_EXITSIZEMOVE = 0x0232,
	kWM_DROPFILES = 0x0233,				kWM_MDIREFRESHMENU = 0x0234,	kWM_IME_SETCONTEXT = 0x0281,		kWM_IME_NOTIFY = 0x0282,			kWM_IME_CONTROL = 0x0283,			kWM_IME_COMPOSITIONFULL = 0x0284,kWM_IME_SELECT = 0x0285,		kWM_IME_CHAR = 0x0286,
	kWM_IME_REQUEST = 0x0288,			kWM_IME_KEYDOWN = 0x0290,		kWM_IME_KEYUP = 0x0291,				kWM_NCMOUSEHOVER = 0x02A0,			kWM_MOUSEHOVER = 0x02A1,			kWM_NCMOUSELEAVE = 0x02A2,		kWM_MOUSELEAVE = 0x02A3,		kWM_CUT = 0x0300,
	kWM_COPY = 0x0301,					kWM_PASTE = 0x0302,				kWM_CLEAR = 0x0303,					kWM_UNDO = 0x0304,					kWM_RENDERFORMAT = 0x0305,			kWM_RENDERALLFORMATS = 0x0306,	kWM_DESTROYCLIPBOARD = 0x0307,	kWM_DRAWCLIPBOARD = 0x0308,
	kWM_PAINTCLIPBOARD = 0x0309,		kWM_VSCROLLCLIPBOARD = 0x030A,	kWM_SIZECLIPBOARD = 0x030B,			kWM_ASKCBFORMATNAME = 0x030C,		kWM_CHANGECBCHAIN = 0x030D,			kWM_HSCROLLCLIPBOARD = 0x030E,	kWM_QUERYNEWPALETTE = 0x030F,	kWM_PALETTEISCHANGING = 0x0310,
	kWM_PALETTECHANGED = 0x0311,		kWM_HOTKEY = 0x0312,			kWM_SYSMENU = 0x0313,				kWM_HOOKMSG = 0x0314,				kWM_EXITPROCESS = 0x0315,			kWM_WAKETHREAD = 0x0316,		kWM_PRINT = 0x0317,				kWM_PRINTCLIENT = 0x0318,
	kWM_APPCOMMAND = 0x0319,			kWM_PENWINFIRST = 0x0380,		kWM_PENWINLAST = 0x038F,			kWM_DDE_INITIATE = 0x03E0,			kWM_DDE_TERMINATE = 0x03E1,			kWM_DDE_ADVISE = 0x03E2,		kWM_DDE_UNADVISE = 0x03E3,		kWM_DDE_ACK = 0x03E4,
	kWM_DDE_DATA = 0x03E5,				kWM_DDE_REQUEST = 0x03E6,		kWM_DDE_POKE = 0x03E7,				kWM_DDE_EXECUTE = 0x03E8,

	kWM_USER = 0x0400,
	kTBM_GETPOS = 0x0400,				kDM_GETDEFID = 0x0400,
	kWM_CHOOSEFONT_GETLOGFONT = 0x0401,	kDM_SETDEFID = 0x0401,			kHKM_SETHOTKEY = 0x0401,			kSB_SETTEXTA = 0x0401,				kPBM_SETRANGE = 0x0401,				kTTM_ACTIVATE = 0x0401,			kTB_ENABLEBUTTON = 0x0401,		kRB_INSERTBANDA = 0x0401,			kTBM_GETRANGEMIN = 0x0401,			kCBEM_INSERTITEMA = 0x0401,			kRB_INSERTBAND = 0x0401,
	kDM_REPOSITION = 0x0402,			kTB_CHECKBUTTON = 0x0402,		kSB_GETTEXTA = 0x0402,				kTBM_GETRANGEMAX = 0x0402,			kCBEM_SETIMAGELIST = 0x0402,		kPBM_SETPOS = 0x0402,			kHKM_GETHOTKEY = 0x0402,		kRB_DELETEBAND = 0x0402,
	kTTM_SETDELAYTIME = 0x0403,			kPBM_DELTAPOS = 0x0403,			kCBEM_GETIMAGELIST = 0x0403,		kTBM_GETTIC = 0x0403,				kRB_GETBARINFO = 0x0403,			kHKM_SETRULES = 0x0403,			kSB_GETTEXTLENGTHA = 0x0403,	kTB_PRESSBUTTON = 0x0403,
	kPBM_SETSTEP = 0x0404,				kSB_SETPARTS = 0x0404,			kTTM_ADDTOOLA = 0x0404,				kTB_HIDEBUTTON = 0x0404,			kCBEM_GETITEMA = 0x0404,			kTBM_SETTIC = 0x0404,			kRB_SETBARINFO = 0x0404,
	kTBM_SETPOS = 0x0405,				kRB_GETBANDINFO = 0x0405,		kTTM_DELTOOLA = 0x0405,				kTB_INDETERMINATE = 0x0405,			kCBEM_SETITEMA = 0x0405,			kPBM_STEPIT = 0x0405,
	kTB_MARKBUTTON = 0x0406,			kPBM_SETRANGE32 = 0x0406,		kRB_SETBANDINFO = 0x0406,			kTBM_SETRANGE = 0x0406,				kCBEM_GETCOMBOCONTROL = 0x0406,		kSB_GETPARTS = 0x0406,			kRB_SETBANDINFOA = 0x0406,		kTTM_NEWTOOLRECTA = 0x0406,
	kRB_SETPARENT = 0x0407,				kTBM_SETRANGEMIN = 0x0407,		kTTM_RELAYEVENT = 0x0407,			kCBEM_GETEDITCONTROL = 0x0407,		kPBM_GETRANGE = 0x0407,				kSB_GETBORDERS = 0x0407,
	kTBM_SETRANGEMAX = 0x0408,			kPBM_GETPOS = 0x0408,			kRB_HITTEST = 0x0408,				kTTM_GETTOOLINFOA = 0x0408,			kCBEM_SETEXSTYLE = 0x0408,			kSB_SETMINHEIGHT = 0x0408,
	kCBEM_GETEXSTYLE = 0x0409,			kCBEM_GETEXTENDEDSTYLE = 0x0409,kTB_ISBUTTONENABLED = 0x0409,		kPBM_SETBARCOLOR = 0x0409,			kRB_GETRECT = 0x0409,				kTTM_SETTOOLINFOA = 0x0409,		kTBM_CLEARTICS = 0x0409,		kSB_SIMPLE = 0x0409,
	kCBEM_HASEDITCHANGED = 0x040A,		kTTM_HITTESTA = 0x040A,			kRB_INSERTBANDW = 0x040A,			kSB_GETRECT = 0x040A,				kTBM_SETSEL = 0x040A,				kTB_ISBUTTONCHECKED = 0x040A,
	kSB_SETTEXTW = 0x040B,				kTTM_GETTEXTA = 0x040B,			kRB_SETBANDINFOW = 0x040B,			kTB_ISBUTTONPRESSED = 0x040B,		kTBM_SETSELSTART = 0x040B,			kCBEM_INSERTITEMW = 0x040B,
	kTB_ISBUTTONHIDDEN = 0x040C,		kRB_GETBANDCOUNT = 0x040C,		kSB_GETTEXTLENGTHW = 0x040C,		kTBM_SETSELEND = 0x040C,			kTTM_UPDATETIPTEXTA = 0x040C,		kCBEM_SETITEMW = 0x040C,
	kSB_GETTEXTW = 0x040D,				kCBEM_GETITEMW = 0x040D,		kTB_ISBUTTONINDETERMINATE = 0x040D,	kRB_GETROWCOUNT = 0x040D,			kTTM_GETTOOLCOUNT = 0x040D,
	kTB_ISBUTTONHIGHLIGHTED = 0x040E,	kCBEM_SETEXTENDEDSTYLE = 0x040E,kTTM_ENUMTOOLSA = 0x040E,			kTBM_GETPTICS = 0x040E,				kSB_ISSIMPLE = 0x040E,				kRB_GETROWHEIGHT = 0x040E,
	kTBM_GETTICPOS = 0x040F,			kTTM_GETCURRENTTOOLA = 0x040F,	kSB_SETICON = 0x040F,
	kRB_IDTOINDEX = 0x0410,				kSB_SETTIPTEXTA = 0x0410,		kTBM_GETNUMTICS = 0x0410,			kTTM_WINDOWFROMPOINT = 0x0410,
	kTB_SETSTATE = 0x0411,				kSB_SETTIPTEXTW = 0x0411,		kRB_GETTOOLTIPS = 0x0411,			kTBM_GETSELSTART = 0x0411,			kTTM_TRACKACTIVATE = 0x0411,
	kRB_SETTOOLTIPS = 0x0412,			kSB_GETTIPTEXTA = 0x0412,		kTB_GETSTATE = 0x0412,				kTTM_TRACKPOSITION = 0x0412,		kTBM_GETSELEND = 0x0412,
	kTTM_SETTIPBKCOLOR = 0x0413,		kTBM_CLEARSEL = 0x0413,			kTB_ADDBITMAP = 0x0413,				kRB_SETBKCOLOR = 0x0413,			kSB_GETTIPTEXTW = 0x0413,
	kSB_GETICON = 0x0414,				kRB_GETBKCOLOR = 0x0414,		kTTM_SETTIPTEXTCOLOR = 0x0414,		kTBM_SETTICFREQ = 0x0414,			kTB_ADDBUTTONS = 0x0414,
	kTBM_SETPAGESIZE = 0x0415,			kTTM_GETDELAYTIME = 0x0415,		kTB_INSERTBUTTON = 0x0415,			kRB_SETTEXTCOLOR = 0x0415,
	kTB_DELETEBUTTON = 0x0416,			kTTM_GETTIPBKCOLOR = 0x0416,	kRB_GETTEXTCOLOR = 0x0416,			kTBM_GETPAGESIZE = 0x0416,
	kRB_SIZETORECT = 0x0417,			kTTM_GETTIPTEXTCOLOR = 0x0417,	kTB_GETBUTTON = 0x0417,				kTBM_SETLINESIZE = 0x0417,
	kTTM_SETMAXTIPWIDTH = 0x0418,		kTBM_GETLINESIZE = 0x0418,		kRB_BEGINDRAG = 0x0418,				kTB_BUTTONCOUNT = 0x0418,
	kRB_ENDDRAG = 0x0419,				kTB_COMMANDTOINDEX = 0x0419,	kTBM_GETTHUMBRECT = 0x0419,			kTTM_GETMAXTIPWIDTH = 0x0419,
	kTB_SAVERESTORE = 0x041A,			kTTM_SETMARGIN = 0x041A,		kTBM_GETCHANNELRECT = 0x041A,		kRB_DRAGMOVE = 0x041A,
	kTTM_GETMARGIN = 0x041B,			kRB_GETBARHEIGHT = 0x041B,		kTB_CUSTOMIZE = 0x041B,				kTBM_SETTHUMBLENGTH = 0x041B,
	kRB_GETBANDINFOW = 0x041C,			kTBM_GETTHUMBLENGTH = 0x041C,	kTB_ADDSTRING = 0x041C,				kTTM_POP = 0x041C,
	kTBM_SETTOOLTIPS = 0x041D,			kRB_GETBANDINFOA = 0x041D,		kTTM_UPDATE = 0x041D,				kTB_GETITEMRECT = 0x041D,
	kTBM_GETTOOLTIPS = 0x041E,			kRB_MINIMIZEBAND = 0x041E,		kTTM_GETBUBBLESIZE = 0x041E,		kTB_BUTTONSTRUCTSIZE = 0x041E,
	kRB_MAXIMIZEBAND = 0x041F,			kTTM_ADJUSTRECT = 0x041F,		kTB_SETBUTTONSIZE = 0x041F,			kTBM_SETTIPSIDE = 0x041F,
	kTB_SETBITMAPSIZE = 0x0420,			kTTM_SETTITLEA = 0x0420,		kTBM_SETBUDDY = 0x0420,
	kTB_AUTOSIZE = 0x0421,				kTTM_SETTITLEW = 0x0421,		kTBM_GETBUDDY = 0x0421,
	kRB_GETBANDBORDERS = 0x0422,
	kTB_GETTOOLTIPS = 0x0423,			kRB_SHOWBAND = 0x0423,
	kTB_SETTOOLTIPS = 0x0424,
	kRB_SETPALETTE = 0x0425,			kTB_SETPARENT = 0x0425,
	kRB_GETPALETTE = 0x0426,
	kRB_MOVEBAND = 0x0427,				kTB_SETROWS = 0x0427,
	kTB_GETROWS = 0x0428,
	kTB_GETBITMAPFLAGS = 0x0429,
	kTB_SETCMDID = 0x042A,
	kRB_PUSHCHEVRON = 0x042B,			kTB_CHANGEBITMAP = 0x042B,
	kTB_GETBITMAP = 0x042C,
	kTB_GETBUTTONTEXT = 0x042D,			kTB_REPLACEBITMAP = 0x042E,		kTB_SETINDENT = 0x042F,				kTB_SETIMAGELIST = 0x0430,			kTB_GETIMAGELIST = 0x0431,

	kTTM_ADDTOOLW = 0x0432,				kTB_LOADIMAGES = 0x0432,		kEM_CANPASTE = 0x0432,				kEM_DISPLAYBAND = 0x0433,			kTTM_DELTOOLW = 0x0433,				kTB_GETRECT = 0x0433,			kTTM_NEWTOOLRECTW = 0x0434,		kEM_EXGETSEL = 0x0434,
	kTB_SETHOTIMAGELIST = 0x0434,		kTTM_GETTOOLINFOW = 0x0435,		kEM_EXLIMITTEXT = 0x0435,			kTB_GETHOTIMAGELIST = 0x0435,		kTB_SETDISABLEDIMAGELIST = 0x0436,	kEM_EXLINEFROMCHAR = 0x0436,	kTTM_SETTOOLINFOW = 0x0436,		kTB_GETDISABLEDIMAGELIST = 0x0437,
	kTTM_HITTESTW = 0x0437,				kEM_EXSETSEL = 0x0437,			kTB_SETSTYLE = 0x0438,				kTTM_GETTEXTW = 0x0438,				kEM_FINDTEXT = 0x0438,				kEM_FORMATRANGE = 0x0439,		kTTM_UPDATETIPTEXTW = 0x0439,	kTB_GETSTYLE = 0x0439,
	kEM_GETCHARFORMAT = 0x043A,			kTB_GETBUTTONSIZE = 0x043A,		kTTM_ENUMTOOLSW = 0x043A,			kEM_GETEVENTMASK = 0x043B,			kTB_SETBUTTONWIDTH = 0x043B,		kTTM_GETCURRENTTOOLW = 0x043B,	kEM_GETOLEINTERFACE = 0x043C,	kTB_SETMAXTEXTROWS = 0x043C,
	kTB_GETTEXTROWS = 0x043D,			kEM_GETPARAFORMAT = 0x043D,		kTB_GETOBJECT = 0x043E,				kEM_GETSELTEXT = 0x043E,			kEM_HIDESELECTION = 0x043F,			kTB_GETBUTTONINFOW = 0x043F,	kEM_PASTESPECIAL = 0x0440,		kTB_SETBUTTONINFOW = 0x0440,
	kEM_REQUESTRESIZE = 0x0441,			kTB_GETBUTTONINFOA = 0x0441,	kTB_SETBUTTONINFOA = 0x0442,		kEM_SELECTIONTYPE = 0x0442,			kEM_SETBKGNDCOLOR = 0x0443,			kEM_SETCHARFORMAT = 0x0444,		kTB_HITTEST = 0x0445,			kEM_SETEVENTMASK = 0x0445,
	kEM_SETOLECALLBACK = 0x0446,		kTB_SETDRAWTEXTFLAGS = 0x0446,	kTB_GETHOTITEM = 0x0447,			kEM_SETPARAFORMAT = 0x0447,			kEM_SETTARGETDEVICE = 0x0448,		kTB_SETHOTITEM = 0x0448,		kTB_SETANCHORHIGHLIGHT = 0x0449,kEM_STREAMIN = 0x0449,
	kEM_STREAMOUT = 0x044A,				kTB_GETANCHORHIGHLIGHT = 0x044A,kEM_GETTEXTRANGE = 0x044B,			kEM_FINDWORDBREAK = 0x044C,			kEM_SETOPTIONS = 0x044D,			kEM_GETOPTIONS = 0x044E,		kTB_MAPACCELERATORA = 0x044E,	kEM_FINDTEXTEX = 0x044F,
	kTB_GETINSERTMARK = 0x044F,			kTB_SETINSERTMARK = 0x0450,		kEM_GETWORDBREAKPROCEX = 0x0450,	kTB_INSERTMARKHITTEST = 0x0451,		kEM_SETWORDBREAKPROCEX = 0x0451,	kTB_MOVEBUTTON = 0x0452,		kEM_SETUNDOLIMIT = 0x0452,		kTB_GETMAXSIZE = 0x0453,
	kEM_REDO = 0x0454,					kTB_SETEXTENDEDSTYLE = 0x0454,	kTB_GETEXTENDEDSTYLE = 0x0455,		kEM_CANREDO = 0x0455,				kTB_GETPADDING = 0x0456,			kEM_GETUNDONAME = 0x0456,		kTB_SETPADDING = 0x0457,		kEM_GETREDONAME = 0x0457,
	kTB_SETINSERTMARKCOLOR = 0x0458,	kEM_STOPGROUPTYPING = 0x0458,	kTB_GETINSERTMARKCOLOR = 0x0459,	kEM_SETTEXTMODE = 0x0459,			kTB_MAPACCELERATORW = 0x045A,		kEM_GETTEXTMODE = 0x045A,		kEM_AUTOURLDETECT = 0x045B,		kTB_GETSTRING = 0x045C,
	kEM_GETAUTOURLDETECT = 0x045C,		kEM_SETPALETTE = 0x045D,		kEM_GETTEXTEX = 0x045E,				kEM_GETTEXTLENGTHEX = 0x045F,		kEM_SHOWSCROLLBAR = 0x0460,			kEM_SETTEXTEX = 0x0461,			kEM_SETPUNCTUATION = 0x0464,	kIPM_CLEARADDRESS = 0x0464,
	kCDM_GETSPEC = 0x0464,				kACM_OPEN = 0x0464,				kWM_CHOOSEFONT_SETLOGFONT = 0x0465,	kCDM_GETFILEPATH = 0x0465,			kPSM_SETCURSEL = 0x0465,			kUDM_SETRANGE = 0x0465,			kACM_PLAY = 0x0465,				kEM_GETPUNCTUATION = 0x0465,
	kIPM_SETADDRESS = 0x0465,			kPSM_REMOVEPAGE = 0x0466,		kEM_SETWORDWRAPMODE = 0x0466,		kACM_STOP = 0x0466,					kUDM_GETRANGE = 0x0466,				kCDM_GETFOLDERPATH = 0x0466,	kWM_CHOOSEFONT_SETFLAGS = 0x0466,kIPM_GETADDRESS = 0x0466,
	kEM_GETWORDWRAPMODE = 0x0467,		kCDM_GETFOLDERIDLIST = 0x0467,	kIPM_SETRANGE = 0x0467,				kPSM_ADDPAGE = 0x0467,				kUDM_SETPOS = 0x0467,				kCDM_SETCONTROLTEXT = 0x0468,	kPSM_CHANGED = 0x0468,			kUDM_GETPOS = 0x0468,
	kIPM_SETFOCUS = 0x0468,				kEM_SETIMECOLOR = 0x0468,		kUDM_SETBUDDY = 0x0469,				kIPM_ISBLANK = 0x0469,				kPSM_RESTARTWINDOWS = 0x0469,		kCDM_HIDECONTROL = 0x0469,		kEM_GETIMECOLOR = 0x0469,		kCDM_SETDEFEXT = 0x046A,
	kPSM_REBOOTSYSTEM = 0x046A,			kEM_SETIMEOPTIONS = 0x046A,		kUDM_GETBUDDY = 0x046A,				kUDM_SETACCEL = 0x046B,				kEM_GETIMEOPTIONS = 0x046B,			kPSM_CANCELTOCLOSE = 0x046B,	kPSM_QUERYSIBLINGS = 0x046C,	kUDM_GETACCEL = 0x046C,
	kPSM_UNCHANGED = 0x046D,			kUDM_SETBASE = 0x046D,			kPSM_APPLY = 0x046E,				kUDM_GETBASE = 0x046E,				kPSM_SETTITLE = 0x046F,				kUDM_SETRANGE32 = 0x046F,		kPSM_SETWIZBUTTONS = 0x0470,	kUDM_GETRANGE32 = 0x0470,
	kUDM_SETPOS32 = 0x0471,				kPSM_PRESSBUTTON = 0x0471,		kUDM_GETPOS32 = 0x0472,				kPSM_SETCURSELID = 0x0472,			kPSM_SETFINISHTEXT = 0x0473,		kPSM_GETTABCONTROL = 0x0474,	kPSM_ISDIALOGMESSAGE = 0x0475,	kPSM_GETCURRENTPAGEHWND = 0x0476,
	kPSM_INSERTPAGE = 0x0477,			kEM_SETLANGOPTIONS = 0x0478,	kEM_GETLANGOPTIONS = 0x0479,		kEM_GETIMECOMPMODE = 0x047A,		kEM_FINDTEXTW = 0x047B,				kEM_FINDTEXTEXW = 0x047C,		kPSM_SETHEADERTITLEA = 0x047D,	kEM_RECONVERSION = 0x047D,
	kPSM_SETHEADERTITLEW = 0x047E,		kPSM_SETHEADERSUBTITLEA = 0x047F,kPSM_SETHEADERSUBTITLEW = 0x0480,	kPSM_HWNDTOINDEX = 0x0481,			kPSM_INDEXTOHWND = 0x0482,			kPSM_PAGETOINDEX = 0x0483,		kPSM_INDEXTOPAGE = 0x0484,		kDL_BEGINDRAG = 0x0485,
	kPSM_IDTOINDEX = 0x0485,			kDL_DRAGGING = 0x0486,			kPSM_INDEXTOID = 0x0486,			kPSM_GETRESULT = 0x0487,			kDL_DROPPED = 0x0487,				kDL_CANCELDRAG = 0x0488,		kPSM_RECALCPAGESIZES = 0x0488,	kEM_SETBIDIOPTIONS = 0x04C8,
	kEM_GETBIDIOPTIONS = 0x04C9,		kEM_SETTYPOGRAPHYOPTIONS = 0x04CA,kEM_GETTYPOGRAPHYOPTIONS = 0x04CB,kEM_SETEDITSTYLE = 0x04CC,			kEM_GETEDITSTYLE = 0x04CD,			kEM_GETSCROLLPOS = 0x04DD,		kEM_SETSCROLLPOS = 0x04DE,		kEM_SETFONTSIZE = 0x04DF,
	kEM_GETZOOM = 0x04E0,				kEM_SETZOOM = 0x04E1,

	kLVM_GETBKCOLOR = 0x1000,			kMCM_GETCURSEL = 0x1001,		kDTM_GETSYSTEMTIME = 0x1001,		kLVM_SETBKCOLOR = 0x1001,			kMCM_SETCURSEL = 0x1002,			kLVM_GETIMAGELIST = 0x1002,
	kDTM_SETSYSTEMTIME = 0x1002,		kLVM_SETIMAGELIST = 0x1003,		kDTM_GETRANGE = 0x1003,				kMCM_GETMAXSELCOUNT = 0x1003,		kDTM_SETRANGE = 0x1004,				kMCM_SETMAXSELCOUNT = 0x1004,	kLVM_GETITEMCOUNT = 0x1004,		kDTM_SETFORMATA = 0x1005,
	kLVM_GETITEM = 0x1005,				kMCM_GETSELRANGE = 0x1005,		kMCM_SETSELRANGE = 0x1006,			kDTM_SETMCCOLOR = 0x1006,			kLVM_SETITEM = 0x1006,				kMCM_GETMONTHRANGE = 0x1007,	kDTM_GETMCCOLOR = 0x1007,		kLVM_INSERTITEM = 0x1007,
	kMCM_SETDAYSTATE = 0x1008,			kDTM_GETMONTHCAL = 0x1008,		kLVM_DELETEITEM = 0x1008,			kMCM_GETMINREQRECT = 0x1009,		kDTM_SETMCFONT = 0x1009,			kLVM_DELETEALLITEMS = 0x1009,	kDTM_GETMCFONT = 0x100A,		kMCM_SETCOLOR = 0x100A,
	kLVM_GETCALLBACKMASK = 0x100A,		kMCM_GETCOLOR = 0x100B,			kLVM_SETCALLBACKMASK = 0x100B,		kMCM_SETTODAY = 0x100C,				kLVM_GETNEXTITEM = 0x100C,			kMCM_GETTODAY = 0x100D,			kLVM_FINDITEM = 0x100D,			kMCM_HITTEST = 0x100E,
	kLVM_GETITEMRECT = 0x100E,			kLVM_SETITEMPOSITION = 0x100F,	kMCM_SETFIRSTDAYOFWEEK = 0x100F,	kLVM_GETITEMPOSITION = 0x1010,		kMCM_GETFIRSTDAYOFWEEK = 0x1010,	kLVM_GETSTRINGWIDTH = 0x1011,	kMCM_GETRANGE = 0x1011,			kMCM_SETRANGE = 0x1012,
	kLVM_HITTEST = 0x1012,				kLVM_ENSUREVISIBLE = 0x1013,	kMCM_GETMONTHDELTA = 0x1013,		kMCM_SETMONTHDELTA = 0x1014,		kLVM_SCROLL = 0x1014,				kMCM_GETMAXTODAYWIDTH = 0x1015,	kLVM_REDRAWITEMS = 0x1015,		kLVM_ARRANGE = 0x1016,
	kLVM_EDITLABEL = 0x1017,			kLVM_GETEDITCONTROL = 0x1018,	kLVM_GETCOLUMN = 0x1019,			kLVM_SETCOLUMN = 0x101A,			kLVM_INSERTCOLUMN = 0x101B,			kLVM_DELETECOLUMN = 0x101C,		kLVM_GETCOLUMNWIDTH = 0x101D,	kLVM_SETCOLUMNWIDTH = 0x101E,
	kLVM_GETHEADER = 0x101F,			kLVM_CREATEDRAGIMAGE = 0x1021,	kLVM_GETVIEWRECT = 0x1022,			kLVM_GETTEXTCOLOR = 0x1023,			kLVM_SETTEXTCOLOR = 0x1024,			kLVM_GETTEXTBKCOLOR = 0x1025,	kLVM_SETTEXTBKCOLOR = 0x1026,	kLVM_GETTOPINDEX = 0x1027,
	kLVM_GETCOUNTPERPAGE = 0x1028,		kLVM_GETORIGIN = 0x1029,		kLVM_UPDATE = 0x102A,				kLVM_SETITEMSTATE = 0x102B,			kLVM_GETITEMSTATE = 0x102C,			kLVM_GETITEMTEXT = 0x102D,		kLVM_SETITEMTEXT = 0x102E,		kLVM_SETITEMCOUNT = 0x102F,
	kLVM_SORTITEMS = 0x1030,			kLVM_SETITEMPOSITION32 = 0x1031,kLVM_GETSELECTEDCOUNT = 0x1032,		kDTM_SETFORMATW = 0x1032,			kLVM_GETITEMSPACING = 0x1033,		kLVM_GETISEARCHSTRING = 0x1034,	kLVM_SETICONSPACING = 0x1035,	kLVM_SETEXTENDEDLISTVIEWSTYLE = 0x1036,
	kLVM_GETEXTENDEDLISTVIEWSTYLE = 0x1037,kLVM_GETSUBITEMRECT = 0x1038,kLVM_SUBITEMHITTEST = 0x1039,		kLVM_SETCOLUMNORDERARRAY = 0x103A,	kLVM_GETCOLUMNORDERARRAY = 0x103B,	kLVM_SETHOTITEM = 0x103C,		kLVM_GETHOTITEM = 0x103D,		kLVM_SETHOTCURSOR = 0x103E,
	kLVM_GETHOTCURSOR = 0x103F,			kLVM_APPROXIMATEVIEWRECT = 0x1040,kLVM_SETWORKAREAS = 0x1041,		kLVM_GETSELECTIONMARK = 0x1042,		kLVM_SETSELECTIONMARK = 0x1043,		kLVM_SETBKIMAGE = 0x1044,		kLVM_GETBKIMAGE = 0x1045,		kLVM_GETWORKAREAS = 0x1046,
	kLVM_SETHOVERTIME = 0x1047,			kLVM_GETHOVERTIME = 0x1048,		kLVM_GETNUMBEROFWORKAREAS = 0x1049,	kLVM_SETTOOLTIPS = 0x104A,			kLVM_GETTOOLTIPS = 0x104E,			kLVM_SORTITEMSEX = 0x1051,		kLVM_INSERTGROUP = 0x1091,		kLVM_SETGROUPINFO = 0x1093,
	kLVM_GETGROUPINFO = 0x1095,			kLVM_REMOVEGROUP = 0x1096,		kLVM_SETGROUPMETRICS = 0x109B,		kLVM_GETGROUPMETRICS = 0x109C,		kLVM_ENABLEGROUPVIEW = 0x109D,		kLVM_SORTGROUPS = 0x109E,		kLVM_INSERTGROUPSORTED = 0x109F,kLVM_REMOVEALLGROUPS = 0x10A0,
	kLVM_HASGROUP = 0x10A1,				kLVM_SETTILEVIEWINFO = 0x10A2,	kLVM_GETTILEVIEWINFO = 0x10A3,		kLVM_SETTILEINFO = 0x10A4,			kLVM_GETTILEINFO = 0x10A5,			kLVM_SETINSERTMARK = 0x10A6,	kLVM_GETINSERTMARK = 0x10A7,	kLVM_INSERTMARKHITTEST = 0x10A8,
	kLVM_GETINSERTMARKRECT = 0x10A9,	kLVM_SETINSERTMARKCOLOR = 0x10AA,kLVM_GETINSERTMARKCOLOR = 0x10AB,	kTVM_INSERTITEM = 0x1100,			kTVM_DELETEITEM = 0x1101,			kTVM_EXPAND = 0x1102,			kTVM_GETITEMRECT = 0x1104,		kTVM_GETCOUNT = 0x1105,
	kTVM_GETINDENT = 0x1106,			kTVM_SETINDENT = 0x1107,		kTVM_GETIMAGELIST = 0x1108,			kTVM_SETIMAGELIST = 0x1109,			kTVM_GETNEXTITEM = 0x110A,			kTVM_SELECTITEM = 0x110B,		kTVM_GETITEM = 0x110C,			kTVM_SETITEM = 0x110D,
	kTVM_EDITLABEL = 0x110E,			kTVM_GETEDITCONTROL = 0x110F,	kTVM_GETVISIBLECOUNT = 0x1110,		kTVM_HITTEST = 0x1111,				kTVM_CREATEDRAGIMAGE = 0x1112,		kTVM_SORTCHILDREN = 0x1113,		kTVM_ENSUREVISIBLE = 0x1114,	kTVM_SORTCHILDRENCB = 0x1115,
	kTVM_ENDEDITLABELNOW = 0x1116,		kTVM_GETISEARCHSTRING = 0x1117,	kTVM_SETTOOLTIPS = 0x1118,			kTVM_GETTOOLTIPS = 0x1119,			kTVM_SETINSERTMARK = 0x111A,		kTVM_SETITEMHEIGHT = 0x111B,	kTVM_GETITEMHEIGHT = 0x111C,	kTVM_SETBKCOLOR = 0x111D,
	kTVM_SETTEXTCOLOR = 0x111E,			kTVM_GETBKCOLOR = 0x111F,		kTVM_GETTEXTCOLOR = 0x1120,			kTVM_SETSCROLLTIME = 0x1121,		kTVM_GETSCROLLTIME = 0x1122,		kTVM_SETINSERTMARKCOLOR = 0x1125,kTVM_GETINSERTMARKCOLOR = 0x1126,kTVM_GETITEMSTATE = 0x1127,
	kTVM_SETLINECOLOR = 0x1128,			kTVM_GETLINECOLOR = 0x1129,		kHDM_GETITEMCOUNT = 0x1200,			kHDM_INSERTITEM = 0x1201,			kHDM_DELETEITEM = 0x1202,			kHDM_GETITEM = 0x1203,			kHDM_SETITEM = 0x1204,			kHDM_LAYOUT = 0x1205,
	kHDM_HITTEST = 0x1206,				kHDM_GETITEMRECT = 0x1207,		kHDM_SETIMAGELIST = 0x1208,			kHDM_GETIMAGELIST = 0x1209,			kHDM_ORDERTOINDEX = 0x120F,			kHDM_CREATEDRAGIMAGE = 0x1210,	kHDM_GETORDERARRAY = 0x1211,	kHDM_SETORDERARRAY = 0x1212,
	kHDM_SETHOTDIVIDER = 0x1213,		kHDM_SETBITMAPMARGIN = 0x1214,	kHDM_GETBITMAPMARGIN = 0x1215,		kHDM_SETFILTERCHANGETIMEOUT = 0x1216,kHDM_EDITFILTER = 0x1217,			kHDM_CLEARFILTER = 0x1218,		kTCM_GETIMAGELIST = 0x1302,		kTCM_SETIMAGELIST = 0x1303,
	kTCM_GETITEMCOUNT = 0x1304,			kTCM_GETITEM = 0x1305,			kTCM_SETITEM = 0x1306,				kTCM_INSERTITEM = 0x1307,			kTCM_DELETEITEM = 0x1308,			kTCM_DELETEALLITEMS = 0x1309,	kTCM_GETITEMRECT = 0x130A,		kTCM_GETCURSEL = 0x130B,
	kTCM_SETCURSEL = 0x130C,			kTCM_HITTEST = 0x130D,			kTCM_SETITEMEXTRA = 0x130E,			kTCM_ADJUSTRECT = 0x1328,			kTCM_SETITEMSIZE = 0x1329,			kTCM_REMOVEIMAGE = 0x132A,		kTCM_SETPADDING = 0x132B,		kTCM_GETROWCOUNT = 0x132C,
	kTCM_GETTOOLTIPS = 0x132D,			kTCM_SETTOOLTIPS = 0x132E,		kTCM_GETCURFOCUS = 0x132F,			kTCM_SETCURFOCUS = 0x1330,			kTCM_SETMINTABWIDTH = 0x1331,		kTCM_DESELECTALL = 0x1332,		kTCM_HIGHLIGHTITEM = 0x1333,	kTCM_SETEXTENDEDSTYLE = 0x1334,
	kTCM_GETEXTENDEDSTYLE = 0x1335,		kPGM_SETCHILD = 0x1401,			kPGM_RECALCSIZE = 0x1402,			kPGM_FORWARDMOUSE = 0x1403,			kPGM_SETBKCOLOR = 0x1404,			kPGM_GETBKCOLOR = 0x1405,		kPGM_SETBORDER = 0x1406,		kPGM_GETBORDER = 0x1407,
	kPGM_SETPOS = 0x1408,				kPGM_GETPOS = 0x1409,			kPGM_SETBUTTONSIZE = 0x140A,		kPGM_GETBUTTONSIZE = 0x140B,		kPGM_GETBUTTONSTATE = 0x140C,

	kCCM_SETBKCOLOR = 0x2001,			kCCM_SETCOLORSCHEME = 0x2002,	kCCM_GETCOLORSCHEME = 0x2003,		kCCM_GETDROPTARGET = 0x2004,		kCCM_SETUNICODEFORMAT = 0x2005,		kCCM_GETUNICODEFORMAT = 0x2006,	kCCM_SETVERSION = 0x2007,		kCCM_GETVERSION = 0x2008,			kOCM_DRAWITEM = 0x202B,
	kOCM_MEASUREITEM = 0x202C,			kOCM_DELETEITEM = 0x202D,		kOCM_VKEYTOITEM = 0x202E,			kOCM_CHARTOITEM = 0x202F,			kOCM_COMPAREITEM = 0x2039,			kOCM_NOTIFY = 0x204E,			kOCM_COMMAND = 0x2111,			kOCM_HSCROLL = 0x2114,
	kOCM_VSCROLL = 0x2115,				kOCM_CTLCOLORMSGBOX = 0x2132,	kOCM_CTLCOLOREDIT = 0x2133,			kOCM_CTLCOLORLISTBOX = 0x2134,		kOCM_CTLCOLORBTN = 0x2135,			kOCM_CTLCOLORDLG = 0x2136,		kOCM_CTLCOLORSCROLLBAR = 0x2137,kOCM_CTLCOLORSTATIC = 0x2138,
	kOCM_PARENTNOTIFY = 0x2210,
};
...
struct MessageRecord {
	...
	WPARAM	wParam;
	LPARAM	lParam;
	MessageRecord(UINT message, wparam wParam, lparam lParam) : message(message), wParam(wParam), lParam(lParam) {}
...
public:
	...
	Params	GetParams()								const { return *this; }
	Point	GetDimension()							const { SIZE size; GetBitmapDimensionEx(*this, &size); return size; }
	bool	SetDimension(const POINT &p)			const { return !!SetBitmapDimensionEx(*this, p.x, p.y, 0); }
	Point	GetSize()								const { return GetParams().Size(); }
	void	GetBits(uint32 *size, void *bits)		const { *size = GetBitmapBits(*this, *size, bits); }
	void	SetBits(uint32 size, const void *bits)	const { SetBitmapBits(*this, size, bits); }

	int				GetBits(HDC hdc, Info &bi, void *buffer, int y, int h, int usage = DIB_RGB_COLORS) const {
		return GetDIBits(hdc, *this, y, h, buffer, (BITMAPINFO*)&bi, usage);
	}
	malloc_block	GetBits(HDC hdc, Info &bi, int y, int h, int usage = DIB_RGB_COLORS) const {
		uint32			scan	= bi.Scan();
		malloc_block	mb(scan * h);
		return GetBits(hdc, bi, mb, y, h, usage) ? mb : malloc_block();
	}

	malloc_block	GetBits(HDC hdc, int y, int h, int usage = DIB_RGB_COLORS) const {
		Info	bi;
		if (GetDIBits(hdc, *this, y, h, 0, (BITMAPINFO*)&bi, usage)) {
			bi.biCompression	= BI_RGB;
			bi.biHeight			= -abs(bi.biHeight);
			return GetBits(hdc, bi, y, h, usage);
		}
		return malloc_block();
	}
...
public:
	...
	bool			Append(const char *s, int id, uint32 flags = 0)		const	{ return !!AppendMenuA(h, flags | MF_STRING, id, s); }
	bool			Append(const char *s, HMENU sub, uint32 flags = 0)	const	{ return !!AppendMenuA(h, flags | MF_STRING | MF_POPUP, UINT_PTR(sub), s); }
...
struct Control::child_iterator {
	...
	child_iterator	operator++(int)		{ Control p = c; c = GetWindow(c, GW_HWNDNEXT); return p; }
	child_iterator	operator--(int)		{ Control p = c; c = GetWindow(c, GW_HWNDPREV); return p; }
...
template<typename T, typename B> struct create_mixin : B {
	...
	create_mixin(HWND hWndParent, text caption, Style style, StyleEx styleEx, const RECT &rect, ID id = ID())	{ T::Create(hWndParent, caption, style, styleEx, rect, id); }
	create_mixin(HWND hWndParent, text caption, Style style, StyleEx styleEx, const POINT &size, ID id = ID())	{ T::Create(hWndParent, caption, style, styleEx, size, id); }
	create_mixin(HWND hWndParent, text caption, Style style, StyleEx styleEx = B::NOEX, ID id = ID())			{ T::Create(hWndParent, caption, style, styleEx, id); }
	create_mixin(const WindowPos &pos, text caption, Style style, StyleEx styleEx = B::NOEX, ID id = ID())		{ T::Create(pos, caption, style, styleEx, id); }
};
...
public:
	...
	static const StyleEx
		GRIDLINES				= StyleEx(0x0001),
		SUBITEMIMAGES			= StyleEx(0x0002),
		CHECKBOXES				= StyleEx(0x0004),
		TRACKSELECT				= StyleEx(0x0008),
		HEADERDRAGDROP			= StyleEx(0x0010),
		FULLROWSELECT			= StyleEx(0x0020),
		ONECLICKACTIVATE		= StyleEx(0x0040),
		TWOCLICKACTIVATE		= StyleEx(0x0080),
		FLATSB					= StyleEx(0x0100),
		REGIONAL				= StyleEx(0x0200),
		INFOTIP					= StyleEx(0x0400),
		UNDERLINEHOT			= StyleEx(0x0800),
		UNDERLINECOLD			= StyleEx(0x1000),
		MULTIWORKAREAS			= StyleEx(0x2000),
		LABELTIP				= StyleEx(0x4000),
		BORDERSELECT			= StyleEx(0x8000),
		DOUBLEBUFFER			= StyleEx(0x00010000),
		HIDELABELS				= StyleEx(0x00020000),
		SINGLEROW				= StyleEx(0x00040000),
		SNAPTOGRID				= StyleEx(0x00080000),
		SIMPLESELECT			= StyleEx(0x00100000),
		JUSTIFYCOLUMNS			= StyleEx(0x00200000),
		TRANSPARENTBKGND		= StyleEx(0x00400000),
		TRANSPARENTSHADOWTEXT	= StyleEx(0x00800000),
		AUTOAUTOARRANGE			= StyleEx(0x01000000),
		HEADERINALLVIEWS		= StyleEx(0x02000000),
		AUTOCHECKSELECT			= StyleEx(0x08000000),
		AUTOSIZECOLUMNS			= StyleEx(0x10000000),
		COLUMNSNAPPOINTS		= StyleEx(0x40000000),
		COLUMNOVERFLOW			= StyleEx(0x80000000);
	enum REGION {
	...
	template<typename C, typename S> struct ColumnT0 : S {
		...
		ColumnT0(const C *s)									{ clear(*this); mask = LVCF_TEXT; pszText = const_cast<char*>(s); }
	...
	template<typename C, typename S> struct ItemT0 : S {
		...
		ItemT0(const C *s)										{ iSubItem = 0; pszText = const_cast<char*>(s); mask = LVIF_TEXT; stateMask = 0; }
		...
		ItemT0&		Text(const C *s)							{ pszText = const_cast<char*>(s ? s : ""); mask |= LVIF_TEXT; return *this; }
	...
	uint32			SetExtendedStyle(StyleEx styleEx, uint32 mask) const { return SendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, mask, styleEx); }
	uint32			SetExtendedStyle(StyleEx styleEx)	const	{ return SendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, styleEx, styleEx); }
	uint32			ClearExtendedStyle(StyleEx styleEx)	const	{ return SendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, styleEx); }
...
public:
	...
	static const StyleEx
		FLATSEPARATORS		= StyleEx(0x0001),
		REGISTERDROP		= StyleEx(0x0002);
...
public:
	...
	HTREEITEM	InsertItem(const char *caption, int image = 0, int imageSelected = 0, HTREEITEM hItemParent = TVI_ROOT, HTREEITEM hItemAfter = TVI_LAST, void *param = NULL) {
	...
	bool		SetItemText(HTREEITEM hItem, const char *caption)	const	{ return Item(hItem).Text(caption).Set(*this); }
...
public:
	...
	static const StyleEx
		DRAWDDARROWS		= StyleEx(0x0001),
		MIXEDBUTTONS		= StyleEx(0x0008),
		HIDECLIPPEDBUTTONS	= StyleEx(0x0010),
		MULTICOLUMN			= StyleEx(0x0002),
		VERTICAL			= StyleEx(0x0004),
		DOUBLEBUFFER		= StyleEx(0x0080);
	...
	DWORD		SetExtendedStyle(StyleEx styleEx)		const	{ return SendMessageL(TB_SETEXTENDEDSTYLE, styleEx); }
...
template<typename T> class WindowHelper {
...
public:
	...
	static LRESULT CALLBACK	thunk(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
		T *wnd = msg == WM_NCCREATE
			? bind((Control*)((CREATESTRUCT*)lParam)->lpCreateParams, hWnd)
			: toT((Control*)GetWindowLongPtr(hWnd, 0));
		return wnd ? wnd->Proc((MSG_ID)msg, wParam, lParam) : DefWindowProc(hWnd, msg, wParam, lParam);
	}
	static T*	Cast(Control c)			{ return c.Class().atom == T::get_class() ? static_cast<T*>((Control*)GetWindowLongPtr(c, 0)) : 0; }
...
template<typename T> T*	CastByProc(Control c)	{ return c.winproc == WindowHelper<T>::thunk ? static_cast<T*>((Control*)GetWindowLongPtr(c, 0)) : 0; }

//-------------------------------------
//	Window
//-------------------------------------

template<class T> class Window : public Control, public WindowHelper<T> {
protected:
	template<typename U> friend class WindowHelper;
	static auto			ClassName()				{ return meta::fixed_name<T>(); }
	...
	static WindowClass	get_class() {
		static WindowClass wc(
			T::ClassName(), WindowHelper<T>::thunk,
			T::get_class_style(), T::get_class_cextra(), T::get_class_wextra(), T::get_class_background(), T::get_class_cursor()
		);
		return wc;
	}

	LRESULT	Super(UINT message, WPARAM wParam = 0, LPARAM lParam = 0) {
		return DefWindowProc(hWnd, message, wParam, lParam);
	}
	template<typename T2> void	Rebind(T2 *t2) {
		SetWindowLongPtr(hWnd, 0, (LONG_PTR)(Control*)static_cast<T*>(t2));
		winproc		= WindowHelper<T2>::thunk;
		t2->Proc(kWM_CREATE, 0, 0);
	}
public:
	static T*	FindAncestor(Control c) { return c.FindAncestor<T>(); }
	static T*	make() { return 0; }

	Window()	{}
	Window(const WindowPos &pos, const char *caption, HMENU hMenu, Style style, StyleEx styleEx = NOEX)		{ T::Create(pos, caption, hMenu, style, styleEx); }
	Window(const WindowPos &pos, const char *caption, Style style, StyleEx styleEx = NOEX, ID id = ID())	{ T::Create(pos, caption, style, styleEx, id); }
};

//-------------------------------------
//	Inherit
//	different WindowClass
//-------------------------------------

template<typename T, typename B> class Inherit : public B, public WindowHelper<T> {
protected:
	template<typename U> friend class WindowHelper;
	static auto			ClassName()	{ return meta::fixed_name<T>(); }
	static WindowClass	get_class() {
		static WindowClass wc(
			ClassName(), WindowHelper<T>::thunk,
			T::get_class_style(), T::get_class_cextra(), T::get_class_wextra(), T::get_class_background(), T::get_class_cursor()
		);
		return wc;
	}
...
public:
	using WindowHelper<T>::Create;
	using WindowHelper<T>::Cast;
	template<typename...PP> Inherit(PP&&...pp) : B(forward<PP>(pp)...) {}
};
...
template<typename T, typename B> class Subclass : public B {
	WNDPROC	prev_proc = 0;
	static void bind(HWND h, void *p, WNDPROC proc) {
		SetWindowLongPtr(h, GWLP_WNDPROC, (LONG_PTR)proc);
		SetWindowLongPtr(h, GWLP_USERDATA, (LONG_PTR)p);
		proc(h, WM_CREATE, 0, 0);
	}
protected:
	template<typename T2> static LRESULT CALLBACK thunk(HWND hWnd, MSG_ID msg, WPARAM wParam, LPARAM lParam) {
		return ((T2*)GetWindowLongPtr(hWnd, GWLP_USERDATA))->Proc(msg, wParam, lParam);
	}
	template<typename T2> void	Rebind(T2 *t2)	{
		bind(hWnd, t2, (WNDPROC)&thunk<T2>);
	}
	void	Unbind() {
	...
	HWND	init(HWND h) {
		...
		bind(h, static_cast<T*>(this), (WNDPROC)&thunk<T>);
		return h;
	}
public:
	using B::hWnd;
...
template<>	inline size_t	string_getter<HWND>::get(char *s, size_t len)	const { return GetWindowTextA(t, s, (int)len + 1); }
template<>	inline size_t	string_getter<HWND>::get(char16 *s, size_t len)	const { return GetWindowTextW(t, s, (int)len + 1); }
