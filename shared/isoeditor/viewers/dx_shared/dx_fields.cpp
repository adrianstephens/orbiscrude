...
template<> const char *field_names<DXGI_FORMAT>::s[]	= {
...
template<> const char *field_names<D3D_SHADER_VARIABLE_CLASS>::s[] = {
	"D3D_SVC_SCALAR",
	"D3D_SVC_VECTOR",
	"D3D_SVC_MATRIX_ROWS",
...
field_bit field_names<D3D_SHADER_VARIABLE_FLAGS>::s[] = {
...
template<> const char *field_names<D3D_SHADER_VARIABLE_TYPE>::s[] = {
	"D3D_SVT_VOID",							// 0,
	"D3D_SVT_BOOL",							// 1,
	"D3D_SVT_INT",							// 2,
	"D3D_SVT_FLOAT",						// 3,
...
field_value field_names<D3D_SHADER_INPUT_FLAGS>::s[] = {
...
template<> const char *field_names<D3D_SHADER_INPUT_TYPE>::s[] = {
	"D3D_SIT_CBUFFER",
	"D3D_SIT_TBUFFER",
	"D3D_SIT_TEXTURE",
	"D3D_SIT_SAMPLER",
...
field_value field_names<D3D_NAME>::s[] = {
...
template<> const char *field_names<D3D_RESOURCE_RETURN_TYPE>::s[] = {
	0,
...
template<> const char *field_names<D3D_REGISTER_COMPONENT_TYPE>::s[] = {
...
template<> const char *field_names<D3D_TESSELLATOR_DOMAIN>::s[] = {
...
template<> const char *field_names<D3D_TESSELLATOR_PARTITIONING>::s[] = {
...
template<> const char *field_names<D3D_TESSELLATOR_OUTPUT_PRIMITIVE>::s[] = {
...
field_value field_names<D3D_MIN_PRECISION>::s[] = {
...
template<> const char *field_names<D3D_INTERPOLATION_MODE>::s[] = {
