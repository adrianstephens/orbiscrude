...
#define ERROR___CPP_INCLUDE                  109, "Cannot open include file %s"
...
#define ERROR_S_TAG_IS_NOT_A_CBUFFER        1055, "tag \"%s\" is not a cbuffer"
...
#define ERROR_S_TAG_IS_NOT_A_TEMPLATE       1069, "tag \"%s\" is not a template"
...
#define ERROR_S_UNRECOGNIZED_PROFILE        3003, "unrecognized profile \"%s\""
#define ERROR___NO_ERROR                    3004, "no error detected since previous error token"
...
#define ERROR_S_OUT_QUALIFIER_IN_SEMANTIC   5111, "out qualifier cannot be used with in semantics \"%s\""
#define ERROR_S_IN_QUALIFIER_OUT_SEMANTIC   5112, "in qualifier cannot be used with out semantics \"%s\""
...
#define ERROR_S_CODE_GENERERATION           9010, "code generation error - %s"
#define ERROR___FOR_LOOP                    9011, "for-loop problem"
